...
namespace Bezi.Bridge.Editor.Fonts
{
    ...
    public static class GoogleFontLibraryManager
    {
        ...
        public static void LoadFontData()
        {
            ...
            var fontDataFile = AssetDatabase.LoadAssetAtPath("Packages/com.bezel.unity/BeziUnityBridge/Editor/Fonts/google-fonts.json", typeof(TextAsset)) as TextAsset;
        ...
        {
            return $"{BeziUnityBridgeImporter.GetFontsFolder()}/{CombinedFontName(fontName,fontWeight)}.ttf";
        }
        ...
        {
            return $"{BeziUnityBridgeImporter.GetFontsFolder()}/{CombinedFontName(fontName,fontWeight)}_SDF.asset";
        }
