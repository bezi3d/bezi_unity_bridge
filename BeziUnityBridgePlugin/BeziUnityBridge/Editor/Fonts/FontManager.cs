...
using MathUtils = Bezi.Bridge.Editor.Utils.MathUtils;

namespace Bezi.Bridge.Editor.Fonts
{

    public class BeziFontMapEntry
    {
    ...
    public class BeziFontMap
    {
        public List<BeziFontMapEntry> FontMapEntries = new List<BeziFontMapEntry>();

        public BeziFontMapEntry GetFontMapping(string fontFamily, int fontWeight)
        {
    ...
    {
        private static BeziFontMap fontMap;

        public static void Reset() {
            fontMap = null;
        }

        public static async Task<BeziFontMap> GenerateFontMapForDocument(string _fontFamily, int _fontWeight, bool enableGoogleFontsDownload)
        {
            if (fontMap == null)
            {
                fontMap = new BeziFontMap();
            }
            ...
            var newFontMapEntry = new BeziFontMapEntry
            {
        ...
        public static Material GetEffectMaterialPreset(BeziFontMapEntry fontMapEntry, bool shadow, Color shadowColor,
            ...
            Color outlineColor, float outlineThickness)
        {
            ...
            //AssetDatabase.CreateAsset(newMaterialPreset, $"{BeziUnityBridgeImporter.GetFontMaterialPresetsFolder()}/{materialName}.mat");
